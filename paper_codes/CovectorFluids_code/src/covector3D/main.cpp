...
void makeCylinderUp(openvdb::FloatGrid::Ptr grid, float radius, float thickness, const Vec3f& center, const openvdb::CoordBBox& indexBB, double h)
{
...
void makeCylinder(openvdb::FloatGrid::Ptr grid, float radius, float thickness, const Vec3f& center, const openvdb::CoordBBox& indexBB, double h)
{
    typename openvdb::FloatGrid::Accessor accessor = grid->getAccessor();
...
void makeSlab(openvdb::FloatGrid::Ptr grid, float radius, float innerRadius, float thickness, const Vec3f& center, const openvdb::CoordBBox& indexBB, double h)
{
    typename openvdb::FloatGrid::Accessor accessor = grid->getAccessor();
...
int main(int argc, char** argv) {
    ...
    if (experiment_name < 0 || experiment_name >= 7)
    {
